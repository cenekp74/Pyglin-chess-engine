...
def evaluate(board):
    if board.is_stalemate() or board.is_repetition() or board.can_claim_threefold_repetition():
        return 0
    eval = 0
    ...
    if amount_of_pieces(board) < 8:
        ...
        if len(json['moves']) > 0:
            ...
            if json['category'] == 'win':
                return -10000  + depthLeft*10, move, None
...
if __name__ == '__main__':
    board = chess.Board('r1b2rk1/ppq1bppp/5n2/2PpN3/8/P2B1Q2/1PPB1PPP/R4RK1 w - - 1 15')
    start = time.time()
